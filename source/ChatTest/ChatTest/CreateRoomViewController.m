...
- (void)viewDidLoad
{
    ...
    nickNameLabel.text = @"Room password";
...
//    [datePicker setMaximumDate:[NSDate date]];
    ...
    [motionPositionBtn setTitle:@"Non Position" forState:UIControlStateNormal];
...
- (void)submitBtnPress
{
    ...
    [app createRoom:roomTextField_.text password:roomPasswordTextField_.text];
}
