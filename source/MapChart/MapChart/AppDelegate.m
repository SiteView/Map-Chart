...
*/    
    ...
    tabBarController.viewControllers = @[positionNavigationController, roomsNavigationController, preferencesNavigationController];
...
- (void)processGroupChatMessage:(XMPPMessage *)message
{
    ...
    RoomModel *room = [roomJoinModel_ objectForKey:roomName];
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    ...
    if (body != nil) {
        ...
        if ([body hasPrefix:@"location"]) {
            ...
            if (room == nil) {
                room = [[RoomModel alloc] init];
                [roomJoinModel_ setObject:room forKey:roomName];
            }
